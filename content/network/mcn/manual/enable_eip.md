...
* 准备至少两台云服务器且绑定到同一个 EIP，并获取两台云服务器的 IP 地址。
* 已创建创建网络服务实例。
* 已获取需开启网络牵引的服务器的 IP 地址。
...
2. 点击云服务器名称下的图标登录其中一台绑定了 EIP 的云服务器。

3. 输入账户和密码，进入云服务器。

4. 执行以下命令尝试是否能 ping 通另一台绑定了 EIP 的云服务器。
